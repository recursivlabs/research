export const SITE = {
  name: 'Recursiv Research',
  short: 'Recursiv Research',
  domain: 'research.on.recursiv.io',
  url: 'https://research.on.recursiv.io',
  tagline: 'Benchmarks test models. Recursiv tests them at work.',
  description:
